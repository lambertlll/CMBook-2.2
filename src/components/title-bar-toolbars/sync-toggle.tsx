  ...
  const syncPanel = (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-muted-foreground">{t('settings.sync.cloudSync')}</span>
        <div className="h-px flex-1 bg-border"></div>
      </div>
      ...
      <div className="flex items-center gap-2">
        <div className="h-px flex-1 bg-border"></div>
        <span className="text-xs text-muted-foreground">{t('settings.sync.localBackupAll')}</span>
        <div className="h-px flex-1 bg-border"></div>
      </div>
