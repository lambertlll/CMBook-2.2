...
function getToneClassName(tone: BannerTone) {
  switch (tone) {
    case 'success':
      return 'border-success/40 bg-success/10 text-success dark:border-success dark:bg-success/30 dark:text-success'
    case 'warning':
      return 'border-warning/40 bg-warning/10 text-warning dark:border-warning dark:bg-warning/30 dark:text-warning'
    case 'danger':
