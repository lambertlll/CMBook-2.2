...
export function AgentPlan({
  ...
  const getStatusIcon = (status: DisplayStep["status"]) => {
    switch (status) {
      ...
      case "in-progress":
        return <CircleDotDashed className="h-4.5 w-4.5 text-primary" />;
      case "need-help":
        return <CircleAlert className="h-4.5 w-4.5 text-warning" />;
      case "failed":
        return <CircleX className="h-4.5 w-4.5 text-danger" />;
      case "pending":
        return <Loader2 className="h-4.5 w-4.5 text-primary animate-spin" />;
      default:
            ...
            {isExpanded && (
              <div className="border-muted mt-1 mr-2 mb-1.5 ml-6 space-y-2">
                ...
                {step.observation && (
                  <div className="text-muted-foreground border-foreground/20 border-l border-dashed pl-3 text-xs">
                    <div className="flex items-center gap-2 py-1">
                      <Eye className="size-3.5 text-success shrink-0" />
                      <span className="font-medium text-xs">
                        {t("observation")}
                      </span>
                    </div>
          ...
          <div className="rounded-md border border-border/50 bg-muted/30 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-3 py-1.5">
              <div className="flex items-center gap-2 min-w-0">
                <Clock className="size-4.5 text-warning shrink-0 animate-pulse" />
      ...
      <div className="w-full mb-4">
        ...
        <div className="flex flex-col items-center justify-center py-8 space-y-4">
          ...
          <div className="flex items-center gap-1.5">
            <div className="size-2 rounded-full bg-primary/60 animate-pulse [animation-delay:0ms]" />
            <div className="size-2 rounded-full bg-primary/60 animate-pulse [animation-delay:150ms]" />
            <div className="size-2 rounded-full bg-primary/60 animate-pulse [animation-delay:300ms]" />
          </div>
        </div>
      </div>
    );
