            ...
            diffData.filter((l) => l.type === "added" || l.type === "removed").map((line, idx) => (
              <div
                ...
                className={cn(
                  ...
                  line.type === "added" && "border-l-success bg-success/10",
                  line.type === "removed" && "border-l-danger bg-danger/10",
    ...
    <span className={cn("text-sm", className)}>
      {changes.map((part, idx) => (
        <span
          ...
          className={cn(
            part.added &&
              "bg-success/30 text-success rounded px-0.5",
            part.removed &&
              "bg-danger/30 text-danger line-through rounded px-0.5"
          )}
        >
          {part.value}
        </span>
