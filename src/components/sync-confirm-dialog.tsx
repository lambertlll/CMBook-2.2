          ...
          <DrawerContent className="max-h-[85vh]">
            ...
            {isConflictDialog && (
              <>
                ...
                <div className="space-y-4 px-4 overflow-y-auto">
                  ...
                  <div className="bg-warning/10 dark:bg-warning/20 border border-warning/40 dark:border-warning p-4 rounded-lg">
            ...
            {isShaMismatchDialog && (
              <>
                ...
                <div className="space-y-4 px-4 overflow-y-auto">
                  <div className="bg-danger/10 dark:bg-danger/20 border border-danger/40 dark:border-danger p-4 rounded-lg">
              ...
              <>
                ...
                <div className="space-y-4 py-4">
                  <div className={cn(
                    ...
                    "border border-danger/40 dark:border-danger"
                  )}>
                    <p className="text-sm text-danger">
                      远程文件的 SHA 与本地记录不一致，可能已被其他设备修改。
                    </p>
