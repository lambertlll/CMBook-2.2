  ...
  return (
    <div className="rounded-md border p-4">
      <div className="flex justify-between items-center mb-2">
        ...
        <Badge className={`${giteeSyncRepoState === SyncStateEnum.success ? 'bg-success' : 'bg-muted'}`}>
      ...
      <div className="space-y-2">
        ...
        <OpenBroswer url="https://gitee.com/profile/personal_access_tokens/new" title={t('settings.sync.newToken')} className="text-sm text-primary hover:underline" />
      </div>
