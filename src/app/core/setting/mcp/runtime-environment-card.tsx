                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        {inspection && (
                          <Badge
                            variant="outline"
                            className={isInstalled ? 'text-success border-success/40' : 'text-warning border-warning/40'}
                          >
                        ...
                        {inspection.checks.map((check) => (
                          <div key={check.command} className="rounded-md border bg-muted/30 p-3 space-y-2">
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <Badge
                                variant="outline"
                                className={check.installed ? 'text-success border-success/40' : 'text-warning border-warning/40'}
                              >
