          ...
          <div>
            ...
            <Tabs value={todoData.priority} onValueChange={(value) => void persistTodoData({ ...todoData, priority: value as Priority })} className="mt-1.5">
              <TabsList className="grid w-full grid-cols-3">
                <TabsTrigger value="low" className="data-[state=active]:bg-success/15 data-[state=active]:text-white">
                  {t('record.mark.todo.priorityLow')}
                </TabsTrigger>
                <TabsTrigger value="medium" className="data-[state=active]:bg-warning/15 data-[state=active]:text-white">
                  {t('record.mark.todo.priorityMedium')}
                </TabsTrigger>
                <TabsTrigger value="high" className="data-[state=active]:bg-danger/15 data-[state=active]:text-white">
