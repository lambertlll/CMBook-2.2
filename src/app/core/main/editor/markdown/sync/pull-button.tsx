      ...
      <div className="flex items-center gap-1">
        ...
        {isLoading ? (
          ...
          <button
            ...
            className="p-0.5 rounded transition-colors hover:bg-danger/10 text-danger flex items-center gap-1"
            title="处理冲突"
          >
          ...
          <button
            onClick={handlePull}
            className="p-0.5 rounded transition-colors hover:bg-warning/10 text-warning flex items-center gap-1"
            title="拉取更新"
          >
            <ArrowDownCircle size={14} />
